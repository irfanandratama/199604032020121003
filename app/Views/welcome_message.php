...
<head>
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        #rekrutmen td, #rekrutmen th {
            border: 1px solid #ddd;
            padding: 8px;
        }

        #rekrutmen tr:nth-child(even){background-color: #f2f2f2;}

        #rekrutmen tr:hover {background-color: #ddd;}
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Rekrutmen Tim Devel</h1>

        <h2>Irfan Hanandra Pratama 199604032020121003</h2>
...
<table id="rekrutmen">
			<thead>				
				<tr>
                    ...
                    <th style="text-align: center;">Bahasa yang dikuasai</th>
					<th style="text-align: center;">Framework yang dikuasai</th>
